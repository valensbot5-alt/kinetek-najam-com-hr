# Najam Kineteka (kinetek-najam.com.hr)

Repo je samostalan. Deploy ide na GitHub Pages iz grane `main`, CNAME je `kinetek-najam.com.hr`.

## Brand kartica

| | |
|---|---|
| Domena | `kinetek-najam.com.hr` |
| Brend | Najam Kineteka |
| Uloga u mreži | Edukacija i vodiči, blog uloga u mreži. |
| Cijena | 14 EUR/dan |
| Telefon | 095 535 1214 |
| Mail | info@kinetek-najam.com.hr |
| Stranica | 24 |
| Gradskih stranica | 0 |

**Stanje na 15.08.2026:** Nema gradskih stranica, sadržaj je tematski.
